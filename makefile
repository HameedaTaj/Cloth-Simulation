...
clean:
	rm -rf *.o base/*.o base/*~ include/*~ python/*~ things/*~ core $(LIB)  *~ *.dSYM swig/*.cxx swig/*~ swig/*.so swig/*.o swig/pba.py* swig/PbaViewer.py swig/PbaThings.py swig/*.pyc ./*.pyc 

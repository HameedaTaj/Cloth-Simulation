...
class DynamicalStateData 
{
  public:
   ...
   ~DynamicalStateData();
    ...
    const Vector& fixpos( const size_t p ) const;
    const Vector& force( const size_t p ) const;
    ...
    void set_fixpos( const size_t p, const Vector& value );
    void set_force( const size_t p, const Vector& value );
  ...
  protected:
    ...
    std::map< std::string, DSAttribute<Vector> >::iterator    forces;
    std::map< std::string, DSAttribute<Vector> >::iterator    fixedpositions;
